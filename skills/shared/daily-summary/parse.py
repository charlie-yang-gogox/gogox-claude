...
This is the CLI extracted from ~/.claude/skills/daily-summary/SKILL.md
(transcript-mode parser, post 2026-04-26 migration). Algorithm preserved
verbatim from SKILL.md; output schema is `schema_version: "1.0"` per
openspec/changes/extract-daily-summary-cli/specs/daily-summary-cli/spec.md.
